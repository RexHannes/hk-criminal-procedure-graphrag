...
function buildMarkdown(demo, payload) {
  ...
  return [
    ...
    `answer_safe: ${payload.product_mode?.answer_safe === true ? "true" : "false"}`,
    `needs_lawyer_review: ${payload.product_mode?.needs_lawyer_review === true ? "true" : "false"}`,
...
(async () => {
  ...
  for (const demo of DEMOS) {
    ...
    summary.push({
      ...
      answer_safe: payload.product_mode?.answer_safe === true,
      needs_lawyer_review: payload.product_mode?.needs_lawyer_review === true,
