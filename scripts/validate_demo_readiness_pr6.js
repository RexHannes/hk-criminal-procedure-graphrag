...
function validateFreezeReport({ status, coverage, retrieval }) {
  ...
  assertEqual(report.pr?.branch, "codex/investor-recall-25k-path", "demo freeze branch");
...
function validateQueryPack() {
  ...
  assertEqual(pack.branch, "codex/investor-recall-25k-path", "demo query pack branch");
