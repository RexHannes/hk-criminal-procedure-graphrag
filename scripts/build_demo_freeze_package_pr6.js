...
const PUBLIC_DEMO = {
  ...
  workspace_route: "/viewer/",
  verified_case_corpus_route: "/viewer/case_corpus_demo.html",
  verified_case_corpus_direct_route: "/viewer/case_corpus_demo.html",
  seed_graph_viewer_route: "/viewer/index_legacy.html",
  legacy_graph_viewer_route: "/viewer/index_legacy.html",
  page_to_show: "For the unmerged draft PR, open the Vercel Preview deployment at /viewer/ to show the polished Legal Graph-SOP Workspace. Then click Verified Case Demo, or open /viewer/case_corpus_demo.html directly, for the source-proofed paragraph-linked case-law demo.",
  legacy_warning: "Graph/domain views are seed-map research UI unless the source-proofed Verified Case Demo is opened. They are not the PR #6 paragraph-linked case-law authority view and must not be presented as verified authority.",
...
function buildReport() {
  ...
  const report = {
    ...
    artifact_paths: {
      ...
      viewer_ui_quality_smoke_test: "scripts/smoke_test_viewer_ui_quality.js",
      ui_demo_quality_check: "artifacts/ui_demo_quality_check.md",
    },
  };
...
function renderReportMarkdown(report) {
  ...
  return [
    ...
    `- Polished workspace route: ${report.public_demo.workspace_route}`,
    ...
    `- Seed graph viewer route: ${report.public_demo.seed_graph_viewer_route}`,
    `- Page to show: ${report.public_demo.page_to_show}`,
    `- Seed graph warning: ${report.public_demo.legacy_warning}`,
    "",
...
function renderBossDemoScript(report, pack) {
  ...
  return [
    ...
    "## Public Demo Page",
    "",
    `For the current unmerged PR, open the Vercel Preview URL recorded in PR #6 and use ${report.public_demo.workspace_route} for the polished Legal Graph-SOP Workspace.`,
    "",
    `After merge or production promotion, open: ${report.public_demo.production_target_url}`,
    "",
    `For the direct verified case-law proof view, open: ${report.public_demo.verified_case_corpus_direct_route}`,
    "",
    "Inside the workspace, click the sidebar entry labelled \"Verified Case Demo\" to open the source-proofed case-law module.",
    "",
    `Do not present graph/domain seed-map views as the verified case-law demo. ${report.public_demo.legacy_warning}`,
    "",
    "## Timing",
    "",
