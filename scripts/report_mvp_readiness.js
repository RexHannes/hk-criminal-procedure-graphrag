...
function report() {
  ...
  return {
    ...
    summary: "v0.7 adds a public-source bail case batch on top of the case-to-proposition graph builder; production HK-law Claude still needs corpus scale, real embeddings/reranking, review promotion, and private-source access controls.",
