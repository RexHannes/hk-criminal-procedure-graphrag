  ...
  return {
    ...
    legal_research_answer: {
      ...
      source_status: {
        ...
        review_status: sourceAudit.review_status || "unreviewed",
        answer_mode: product_mode.answer_mode,
        lawyer_review_status: product_mode.lawyer_review_status,
        professional_advice_certified: product_mode.professional_advice_certified,
