...
- Native Verified Case Demo: /viewer/ native Verified Case Demo section
- Native Verified Case Demo route: /viewer/ native Verified Case Demo section
- Seed graph viewer route: /viewer/index_legacy.html
- Page to show: For the unmerged draft PR, open the Vercel Preview deployment at /viewer/ to show the polished Legal Graph-SOP Workspace. Then click Verified Case Demo for the source-proofed paragraph-linked case-law demo.
...
- Use the Verified Case Demo sidebar entry/card inside /viewer/ for the source-proofed case-law demo.
